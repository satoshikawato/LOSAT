...
The [2026-09-05 follow-up](followup-20260905/EVIDENCE.md) reconciles the
catalog to **74 PASS / 10 TIMEOUT**. Six formerly incomplete rows (p06,
p10 and d04, native/serial) are now validated. The cold/warm performance
measurements below are reused unchanged; the contended audit retries are
excluded from medians. PR01 remains **NOT_PROVEN / NOT_ACCEPTED**, with p11
timing coverage still absent. The original 120-second tables follow.
