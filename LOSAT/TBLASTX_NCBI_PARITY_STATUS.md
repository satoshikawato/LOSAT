...
**作成日時**: 2026-01-03  
**更新日時**: 2026-01-04 (Subject frame ソートバグ修正、HSP 過剰生成問題を特定)  
...
**調査すべき箇所**:
1. `utils.rs` の two-hit ロジック (window サイズ、判定条件)
...
- **調査結果**: カリングは主に出力前処理で適用され、リンキング前には適用されない模様
- **結論**: 過剰ヒットの原因ではない（要追加調査）
