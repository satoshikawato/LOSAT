...
**2026-09-25 Kappa result continuation:** [CHECKPOINT_KAPPA_RESULT_20260925.md](CHECKPOINT_KAPPA_RESULT_20260925.md) records final composition-heap pop→hitlist update/replacement→result reversal call-state comparisons, including a natural Rust 13-subject chain and a comparison-only max-target-seqs-2 deletion fixture. Stage D remains partial; Stage E remains blocked.
