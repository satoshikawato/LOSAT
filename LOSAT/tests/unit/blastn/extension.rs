...
fn test_extend_hit_ungapped_perfect_match() {
    ...
    let (q_start, q_end, s_start, s_end, score) =
        extend_hit_ungapped(q_seq, s_seq, 2, 2, 1, -2, None);
...
fn test_extend_hit_ungapped_at_sequence_start() {
    ...
    let (q_start, q_end, s_start, s_end, score) =
        extend_hit_ungapped(q_seq, s_seq, 0, 0, 1, -2, None);
...
fn test_extend_hit_ungapped_at_sequence_end() {
    ...
    let (q_start, q_end, s_start, s_end, score) =
        extend_hit_ungapped(q_seq, s_seq, last_pos, last_pos, 1, -2, None);
...
fn test_extend_hit_ungapped_coordinates() {
    ...
    let start_pos = 4;
    let (q_start, q_end, s_start, s_end, _score) =
        extend_hit_ungapped(q_seq, s_seq, start_pos, start_pos, 1, -2, None);
